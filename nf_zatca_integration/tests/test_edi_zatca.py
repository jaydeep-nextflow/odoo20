...
class TestEdiZatca(TestSaEdiCommon):
    ...
    def _test_document_generation(self, test_file_path, expected_xpath, freeze_time_at, additional_xpath='', document_type=False, move=False, move_data=False):
        ...
        with freeze_time(freeze_time_at):
            ...
            final_move._nf_zatca_generate_unsigned_data()
            generated_file = self.env['account.edi.format']._nf_zatca_generate_zatca_template(final_move)
    ...
    def testCreditNoteSimplified(self):
        ...
        self._test_document_generation(
            ...
            test_file_path='nf_zatca_integration/tests/compliance/simplified/credit.xml',
    ...
    def testCreditNoteStandard(self):
        ...
        self._test_document_generation(
            document_type='credit_note',
            test_file_path='nf_zatca_integration/tests/compliance/standard/credit.xml',
            expected_xpath=self.credit_note_applied_xpath,
            move_data=move_data,
    ...
    def testDebitNoteSimplified(self):
        ...
        self._test_document_generation(
            ...
            test_file_path='nf_zatca_integration/tests/compliance/simplified/debit.xml',
    ...
    def testDebitNoteStandard(self):
        ...
        self._test_document_generation(
            document_type='debit_note',
            test_file_path='nf_zatca_integration/tests/compliance/standard/debit.xml',
            expected_xpath=self.debit_note_applied_xpath,
            move_data=move_data,
    ...
    def testInvoiceSimplified(self):
        ...
        self._test_document_generation(
            ...
            test_file_path='nf_zatca_integration/tests/compliance/simplified/invoice.xml',
    ...
    def testInvoiceStandard(self):
        ...
        self._test_document_generation(
            document_type='invoice',
            test_file_path='nf_zatca_integration/tests/compliance/standard/invoice.xml',
            expected_xpath=self.invoice_applied_xpath,
            move_data=move_data,
    ...
    def testInvoiceWithDownpayment(self):
        ...
        for move, test_file in [
            ...
            with self.subTest(move=move, test_file=test_file):
                self._test_document_generation(
                    test_file_path=f'nf_zatca_integration/tests/test_files/{test_file}.xml',
                    expected_xpath=self.invoice_applied_xpath,
