...
class TestSaEdiCommon(AccountEdiTestCommon):
    ...
    @classmethod
    @AccountEdiTestCommon.setup_edi_format('nf_zatca_integration.zatca_account_edi_format')
    ...
    def _setup_company(cls):
        ...
        cls.company.write({
            ...
            'nf_zatca_building_number': '1234',
            'nf_zatca_plot_identification': '1234',
            'nf_zatca_additional_identification_number': '2525252525252',
            'nf_zatca_additional_identification_scheme': 'CRN',  # Commercial Registration Number
        })
    ...
    def _create_saudi_company_partner(cls):
        ...
        return cls.env['res.partner'].create({
            ...
            # Tax info
            'vat': '311111111111113',
            'nf_zatca_additional_identification_scheme': 'CRN',
            'nf_zatca_additional_identification_number': '353535353535353',
            # Address
            ...
            'nf_zatca_building_number': '12300',
            'nf_zatca_plot_identification': '2323',
        })
    ...
    def _create_saudi_individual_partner(cls):
        ...
        return cls.env['res.partner'].create({
            ...
            'nf_zatca_additional_identification_scheme': 'MOM',  # Momra License
            'nf_zatca_additional_identification_number': '3123123213131',
        })
    ...
    def _setup_journal(cls):
        ...
        cls.customer_invoice_journal._nf_zatca_load_edi_demo_data()
